...
*/
(function(T, K) {
    "object" === typeof module && module.exports ? module.exports = T.document ? K(T) : K : T.HighchartsExtended = K(T)
    ...
    var K = function() {
        var a = "undefined" === typeof T ? window : T,
            ...
            t = g && 4 > parseInt(F.split("Firefox/")[1],
                10);
        return a.HighchartsExtended ? a.HighchartsExtended.error(16, !0) : {
            product: "HighchartsExtended",
            version: "6.1.0",
    ...
    (function(a) {
        ...
        a.error = function(r, g) {
            r = a.isNumber(r) ? "HighchartsExtended error #" + r + ": www.highcharts.com/errors/" + r : r;
            if (g) throw Error(r);
    ...
    (function(a) {
        ...
        p(F.prototype, {
            ...
            init: function(a, h, b, c, v, f) {
                ...
                this.createElement("desc").add().element.appendChild(k.createTextNode("Created with HighchartsExtended 6.1.0"));
