/*
 HighchartsExtended JS v6.1.0 (2018-04-13)
 HighchartsExtended Drilldown module
...
*/
(function(p) {
    "object" === typeof module && module.exports ? module.exports = p : p(HighchartsExtended)
})(function(p) {
    (function(d) {
        var p = d.animObject,
            x = d.noop,
        ...
        m.prototype.addSingleSeriesAsDrilldown = function(a, b) {
            ...
            (r = this.drilldownLevels[this.drilldownLevels.length - 1]) && r.levelNumber !== l && (r = void 0);
            b = q(q({
                _ddSeriesId: E++
            }, m), b);
            g = D(a, c.points);
            k(c.chart.series, function(a) {
                a.xAxis !== e || a.isDrilling || (a.options._ddSeriesId = a.options._ddSeriesId || E++, a.options._colorIndex = a.userOptions._colorIndex, a.options._levelNumber = a.options._levelNumber || l, r ? (h = r.levelSeries, v = r.levelSeriesOptions) : (h.push(a),
                    v.push(a.options)))
            });
            a = q({
                levelNumber: l,
        ...
        m.prototype.applyDrilldown = function() {
            var a = this.drilldownLevels,
                b;
            a && 0 < a.length && (b = a[a.length - 1].levelNumber, k(this.drilldownLevels, function(a) {
        ...
        m.prototype.showDrillUpButton = function() {
            ...
            this.drillUpButton ? this.drillUpButton.attr({
                text: b
            }).align() : (f = (e = c.theme) && e.states, this.drillUpButton = this.renderer.button(b, null, null, function() {
                    a.drillUp()
                },
        ...
        m.prototype.drillUp = function() {
            if (this.drilldownLevels && 0 !== this.drilldownLevels.length) {
                for (var a = this, b = a.drilldownLevels, c = b[b.length - 1].levelNumber, e = b.length, f = a.series, g, h, d, l, m = function(b) {
                    ...
                    if (h = b[e], h.levelNumber === c) {
                        b.pop();
                        d = h.lowerSeries;
                        if (!d.chart)
                            for (g = f.length; g--;)
                                if (f[g].options.id === h.lowerSeriesOptions.id && f[g].options._levelNumber === c + 1) {
                                    d = f[g];
                                    break
                                }
                        d.xData = [];
                        ...
                        d.remove(!1);
                        l.xAxis && (g = h.oldExtremes,
                            l.xAxis.setExtremes(g.xMin, g.xMax, !1), l.yAxis.setExtremes(g.yMin, g.yMax, !1));
        ...
        d.addEvent(m, "render", function() {
            k(this.xAxis || [], function(a) {
                a.ddPoints = {};
                k(a.series, function(b) {
                    var c, e = b.xData || [],
                        f = b.points,
                        d;
                    for (c = 0; c < e.length; c++) d = b.options.data[c], "number" !== typeof d && (d = b.pointClass.prototype.optionsToObject.call({
                        series: b
                    }, d), d.drilldown && (a.ddPoints[e[c]] || (a.ddPoints[e[c]] = []), a.ddPoints[e[c]].push(f ? f[c] : !0)))
                });
            ...
            if (!a) {
                ...
                d.syncTimeout(function() {
                    b.points && k(b.points, function(a, b) {
                        ...
                        var e = "show" === b ? !0 : void 0,
                            d = a.dataLabel;
                        if (a.graphic) a.graphic[b](e);
        ...
        n.prototype.animateDrilldown = function(a) {
            var b = this,
                ...
                e, d = p(this.chart.options.drilldown.animation),
                g = this.xAxis;
            a || (k(c, function(a) {
                b.options._ddSeriesId === a.lowerSeriesOptions._ddSeriesId && (e = a.shapeArgs, e.fill = a.color)
            }), e.x += t(g.oldPos, g.pos) - g.pos, k(this.points, function(a) {
        ...
        n.prototype.animateDrillupFrom =
            function(a) {
                var b = p(this.chart.options.drilldown.animation),
                    c = this.group,
                    e = c !== this.chart.columnGroup,
                    f = this;
                k(f.trackerGroups, function(a) {
                    if (f[a]) f[a].on("mouseover")
                });
                e && delete this.group;
                k(this.points, function(f) {
                    var h = f.graphic,
                        g = a.shapeArgs,
                        l = function() {
                            h.destroy();
                    ...
                    h && (delete f.graphic, g.fill = a.color, b.duration ? h.animate(g, d.merge(b, {
                        complete: l
                    })) : (h.attr(g), l()))
                })
            };
        B && q(B.prototype, {
            ...
            animateDrilldown: function(a) {
                var b = this.chart.drilldownLevels[this.chart.drilldownLevels.length - 1],
                    ...
                    e = b.shapeArgs,
                    f = e.start,
                    g = (e.end - f) / this.points.length;
                a || (k(this.points, function(a, k) {
                    var h = a.shapeArgs;
                    e.fill = b.color;
                    h.fill = a.color;
                    if (a.graphic) a.graphic.attr(d.merge(e, {
                        start: f + k * g,
                        end: f + (k + 1) * g
                    }))[c ? "animate" : "attr"](h, c)
                }), this.animate = null)
        ...
        d.Point.prototype.doDrilldown = function(a, b, c) {
            var d = this.series.chart,
                ...
                h;
            d.ddDupes || (d.ddDupes = []);
            for (; g-- && !h;) f.series[g].id === this.drilldown && -1 === D(this.drilldown, d.ddDupes) && (h = f.series[g], d.ddDupes.push(this.drilldown));
            u(d, "drilldown", {
                point: this,
                seriesOptions: h,
                category: b,
        ...
        C.prototype.drillable = function() {
            var a = this.pos,
                b = this.label,
                c = this.axis,
                e = "xAxis" === c.coll && c.getDDPoints,
                f = e && c.getDDPoints(a);
            e && (b && f && f.length ? (b.drillable = !0, b.basicStyles || (b.basicStyles = d.merge(b.styles)), b.addClass("highcharts-drilldown-axis-label").css(c.chart.options.drilldown.activeAxisLabelStyle).on("click",
                function(b) {
        ...
        d.addEvent(d.Series, "afterDrawDataLabels", function() {
            ...
            k(this.points, function(c) {
                var d = c.options.dataLabels,
                    f = t(c.dlOptions, d && d.style, {});
                c.drilldown && c.dataLabel && ("contrast" === a.color && (f.color = b.getContrast(c.color || this.color)), d && d.color && (f.color = d.color), c.dataLabel.addClass("highcharts-drilldown-data-label"), c.dataLabel.css(a).css(f))
            }, this)
        });
        ...
        d.addEvent(d.Point, "afterSetState", function() {
            this.drilldown && this.series.halo && "hover" === this.state ? w(this.series.halo, "pointer", !0) : this.series.halo && w(this.series.halo, "auto", !1)
        })
    })(p)
});
